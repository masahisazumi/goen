          ...
          <Card className="border-0 shadow-md rounded-2xl">
            <CardContent className="py-8 prose prose-gray max-w-none">
              <p className="text-muted-foreground mb-8">
                いいこと（以下「当社」）は、本サービス「てんむすび」（以下「本サービス」）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。
              </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-2">当社が個人情報を収集・利用する目的は、以下のとおりです。</p>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold mb-4">第9条（Cookieの使用について）</h2>
                <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                  <li>当社のサービスは、Cookie及びこれに類する技術を利用することがあります。これらの技術は、当社による本サービスの利用状況等の把握に役立ち、サービス向上に資するものです。</li>
                  <li>Cookieを無効化されたいユーザーは、ウェブブラウザの設定を変更することによりCookieを無効化することができます。ただし、Cookieを無効化すると、本サービスの一部の機能をご利用いただけなくなる場合があります。</li>
                </ol>
              </section>

              <section className="mb-8">
                <h2 className="text-xl font-bold mb-4">第10条（プライバシーポリシーの変更）</h2>
                <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              ...
              <section className="mb-8">
                ...
                <div className="mt-4 p-4 bg-muted/50 rounded-xl text-muted-foreground">
                  <p>事業者名：いいこと</p>
                  <p>代表者名：富永愛理</p>
